...
$sql2=mysqli_query($conexion,"SELECT * FROM usuarios WHERE email='$username'"); //2
...
$sql=mysqli_query($conexion,"SELECT * FROM usuarios WHERE email='$username'");
	if($f=mysqli_fetch_assoc($sql)){
		if($pass==$f['contrasena']){
			$_SESSION['Id']=$f['Id'];
			$_SESSION['nombre']=$f['nombre'];
			$_SESSION['Idtipousuario']=$f['Idtipousuario'];
